...
Usage:
    python3 Scripts/21_link_gbif_datasets_to_publications.py --dry-run
    python3 Scripts/21_link_gbif_datasets_to_publications.py
    python3 Scripts/21_link_gbif_datasets_to_publications.py --limit-datasets 100
    python3 Scripts/21_link_gbif_datasets_to_publications.py --force-refresh
    python3 Scripts/21_link_gbif_datasets_to_publications.py --dry-run --max-pages-per-dataset 5
    python3 Scripts/21_link_gbif_datasets_to_publications.py --workers 4 --sleep 0.5
"""
